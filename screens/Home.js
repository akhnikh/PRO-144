...
export default class HomeScreen extends Component {
  ...
  getArticle = () => {
    ...
    axios.get("http://localhost:5000/get-article").then((response)=>{
  ...
  likedArticle = () => {
    ...
    axios.get("http://localhost:5000/liked-article").then((response)=>{
    this.getArticle()
    }).catch((error)=>{
      console.log(error.message)
    })
  ...
  unlikedArticle = () => {
    /*Complete the getArticle() function.*/
    axios.get("http://localhost:5000/unliked-article").then((response)=>{
      this.getArticle()
      }).catch((error)=>{
        console.log(error.message)
      })
